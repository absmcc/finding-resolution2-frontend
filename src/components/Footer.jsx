  ...
  return (
    <>
      <footer className="footer">
        <p className="footer-text"> Maria Redman Carson Copywrite 2022</p>
...
{/* 
      <FooterContainer id="footer">
        <FooterWrap>
          <SocialMedia>
            <SocialMediaWrap>
              <SocialLogo to="/">Finding Resolution</SocialLogo>
              <WebsiteRights>
                Finding Resolution {new Date().getFullYear()} All rights
                reserved.
              </WebsiteRights>
              <SocialIcons>
                <SocialIconLink
                  href="https://github.com/absmcc"
                  target="_blank"
                  arial-label="Github"
                >
                  <FaGithub />
                ...
                <SocialIconLink
                  href="https://www.linkedin.com/in/maria-carson-4413571a/"
                  target="_blank"
                ...
                <SocialIconLink
                  href="https://www.bocacode.com/candidates/software-engineer/maria-carson"
                  target="_blank"
                  arial-label="School"
                >
                  <FaSchool />
